...
- Select background image, audio file, LRC lyrics, and output path
...
Pre-built Windows builds are available on the [Releases](https://github.com/EternalAcacia/SLVGenerator/releases) page. Download `SLVGenerator-v1.0.0-windows.zip`, extract it, and run `SLVGenerator.exe`.
...
Windows 预编译版本可在 [Releases](https://github.com/EternalAcacia/SLVGenerator/releases) 页面下载。下载 `SLVGenerator-v1.0.0-windows.zip`，解压后运行 `SLVGenerator.exe` 即可。
